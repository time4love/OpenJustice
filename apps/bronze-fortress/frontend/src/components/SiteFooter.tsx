      ...
      <div className="max-w-4xl mx-auto px-4 py-5 flex flex-wrap items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          <a
            ...
            className="flex items-center gap-1.5 text-xs text-slate-400 hover:text-amber-400 transition-colors font-mono"
          >
            <GitHubIcon />
            Open Source
          </a>
        ...
        <a
          href="https://github.com/time4love/OpenJustice/tree/master/apps/bronze-fortress"
          target="_blank"
          rel="noopener noreferrer"
