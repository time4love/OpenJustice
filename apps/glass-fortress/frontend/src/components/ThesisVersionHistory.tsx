...
// ---------------------------------------------------------------------------
// The version history of one thesis — every saved version, newest last, with a
// word-level diff between consecutive ones.
//
// A component rather than a page. It used to be a route of its own with its own
// bespoke header, so reaching it meant leaving the thesis behind and losing the
// view switcher: the one control that says which way of looking at this thesis
// you are in. It is a third VIEW of the same object, not a different place.
// ---------------------------------------------------------------------------
...
export function ThesisVersionHistory({ id }: { id: string }) {
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-lg font-bold text-slate-900">{t('historyHeading')}</h2>
