        ...
        >
          ...
          <div className="bg-slate-900 px-4 py-3 flex items-center justify-between shrink-0">
            <div className="flex items-center gap-2.5">
              <div className="w-8 h-8 rounded-full bg-blue-600 flex items-center justify-center select-none">
                <Image src="/icon_dove.png" alt="" width={20} height={20} className="w-5 h-5" />
              </div>
              <div>
