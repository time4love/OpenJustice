...
//
// Deliberately not shared with forensics/page.tsx's DiffNode — see the note
// there. This is the richer, interactive variant (significance-driven
// styling, expand/collapse, promote action) for reviewing a URL's full diff
// history; DiffNode is the simpler always-expanded view for a fresh scan's
// results.
// ---------------------------------------------------------------------------
