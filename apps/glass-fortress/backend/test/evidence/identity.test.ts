...
const NAMED_HASHERS: Record<string, string> = {
  ...
  'lib/thesisIdentity.ts': "a thesis version's contentHash — the approved text's UTF-8 bytes (thesis A1 :1231) — and a gap's id over its normalised description (A1 :1234)",
  'services/thesisPredicates.ts': 'FINGERPRINT — the input an analysis was about (thesis A3 :1376–:1378), the layout stated in the module',
