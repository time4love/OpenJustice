// Auto-extracted from contracts/out/EvidenceRegistry.sol/EvidenceRegistry.json
// Regenerate after any contract change: forge build, then re-export this array.
