...
- **The schema.** An era needs a validity range, a confirmed/frozen flag, and a version chain for
  supersession. The migration is additive; every existing run becomes one era covering all time.
