...
first (prosecutor §4 :87; researcher day :61–:62). A row: the claim's first words (in `.record-captured` — §26 :820's own rule applied, 2026-09-20: the words are the archive's extracted bytes, a document the platform did not author, and the thesis page's `#tr_` pane already draws them so) · the page's label · the
