...
3  THE PAGE CARD      AMENDED 2026-09-18: it REPLACES the date axis and sits BELOW the filters. The page's **RULED 2026-09-21 (the researcher, R68 board ט·ב): the page card is the FIRST element of a single-page view, above the filters — a header that says the view is ONE page's.**
